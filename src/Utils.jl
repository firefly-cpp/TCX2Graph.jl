...
"""
    save_rules_to_txt(rules::Vector, output_file::String)

Saves the generated association rules to a text file.

# Arguments
- `rules::Vector`: A vector of association rules generated by NiaARM.
- `output_file::String`: The file path where the rules should be saved.

# Details
Each rule will be written to the text file, including the antecedent, consequent, and fitness score. If the fitness was not calculated (`fitness == -Inf`), a warning message will be included in the output.
"""
